...
class FreqPlan
{ public:
   uint8_t  Plan;        // 1=Europe/Africa, 2=USA/Canada, 3=Australia/South America, 4=New Zealand
  ...
  public:
   ...
   { Plan=NewPlan;
          if(Plan==2) { BaseFreq=902200000; ChanSepar=400000; Channels=65; } // USA/Canada
     else if(Plan==3) { BaseFreq=917000000; ChanSepar=400000; Channels=24; } // Australia/South America
     else if(Plan==4) { BaseFreq=869250000; ChanSepar=200000; Channels= 1; } // New Zealand
     else             { BaseFreq=868200000; ChanSepar=200000; Channels= 2; } // Europe/Africa
   }
   ...
   { static const char *Name[5] = { "Default", "Europe/Africa", "USA/Canada", "Australia/South America", "New Zealand" } ;
     if(Plan>4) return 0;
     return Name[Plan]; }
